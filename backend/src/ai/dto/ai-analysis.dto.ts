import { IsString, IsNotEmpty, IsEnum, IsOptional, Length, IsUrl, Matches } from 'class-validator'
...
export class AIAnalysisRequestDto {
    ...
    // Allow all characters including French, emojis, etc.
    content: string
    ...
    @Transform(({ obj }) => {
        ...
        if (obj.contentType === ContentType.CONTENT) {
            ...
            const limits = platformLimits[obj.platform as keyof typeof platformLimits]
